      ...
      <div className="mt-8 w-full rounded-2xl border border-[var(--hub-border)] bg-white p-8 shadow-[var(--hub-card-shadow)] sm:p-10">
        {!sent ? (
          <>
            ...
            <form onSubmit={handleSubmit} className="mt-8 space-y-5">
              <div className="space-y-2">
                <label htmlFor="client-hub-email" className="text-[13px] font-semibold text-[var(--hub-text-strong)]">
                  Work email
                </label>
                <input
                  id="client-hub-email"
                  ...
                  className="w-full rounded-xl border border-[var(--hub-border)] bg-white px-4 py-3 text-sm text-[var(--hub-text-strong)] placeholder:text-[var(--hub-text-muted)] transition focus:border-[var(--hub-accent)] focus:outline-none focus:ring-1 focus:ring-[var(--hub-accent-soft)]"
                />
              </div>
            ...
            <div className="mt-6 border-t border-[var(--hub-border)] pt-5">
              <div className="flex items-center justify-center gap-6 text-[11px] text-[var(--hub-text-muted)]">
          ...
          <div className="text-center">
            ...
            <h2 className="mt-5 text-2xl font-semibold tracking-[-0.03em] text-[var(--hub-text-strong)]">
              Check your email
            </h2>
            <p className="mx-auto mt-3 max-w-sm text-[13px] leading-6 text-[var(--hub-text-soft)]">
            ...
            <button
              ...
              className="mt-4 text-[13px] font-medium text-[var(--hub-text-muted)] transition hover:text-[var(--hub-text-strong)]"
            >
