...
-- CreateEnum
CREATE TYPE "mailbox_audit_action" AS ENUM ('CONNECTION_CREATED', 'CONNECTION_DISCONNECTED', 'CONNECTION_RECONNECTED', 'CONNECTION_DEGRADED', 'CONNECTION_PERMISSION_CHANGED', 'CONNECTION_POLICY_UPDATED', 'THREAD_ASSIGNED', 'THREAD_UNASSIGNED', 'THREAD_STATUS_CHANGED', 'THREAD_LINKED', 'THREAD_UNLINKED', 'MESSAGE_SENT', 'MESSAGE_REPLIED', 'MESSAGE_FORWARDED', 'DRAFT_CREATED', 'DRAFT_DISCARDED', 'SYNC_MANUAL_TRIGGERED', 'SYNC_COMPLETED', 'SYNC_FAILED', 'ADMIN_SUPPORT_ACTION');
...
-- CreateEnum
CREATE TYPE "mailbox_sync_run_status" AS ENUM ('RUNNING', 'COMPLETED', 'FAILED');
...
CREATE TABLE "mailbox_connection" (
    ...
    "visibilityPolicy" TEXT NOT NULL DEFAULT 'org_shared',
    "tokenRef" TEXT,
...
CREATE TABLE "mailbox_audit_event" (
    ...
    "metadata" JSONB,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "mailboxThreadId" TEXT,
    "mailboxMessageId" TEXT,
...
-- CreateTable
CREATE TABLE "mailbox_thread" (
    "id" TEXT NOT NULL,
    "orgId" TEXT NOT NULL,
    "mailboxConnectionId" TEXT NOT NULL,
    "providerThreadId" TEXT NOT NULL,
    "subject" TEXT NOT NULL,
    "participantsSummary" JSONB NOT NULL DEFAULT '[]',
    "lastMessageAt" TIMESTAMP(3) NOT NULL,
    "unreadCount" INTEGER NOT NULL DEFAULT 0,
    "status" "mailbox_thread_status" NOT NULL DEFAULT 'OPEN',
    "assigneeId" UUID,
    "isFlagged" BOOLEAN NOT NULL DEFAULT false,
    "primaryLinkSummary" JSONB,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
-- CreateTable
CREATE TABLE "mailbox_sync_run" (
    "id" TEXT NOT NULL,
    "orgId" TEXT NOT NULL,
    "mailboxConnectionId" TEXT NOT NULL,
    "provider" "mailbox_provider" NOT NULL,
    "status" "mailbox_sync_run_status" NOT NULL,
    ...
    CONSTRAINT "mailbox_sync_run_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE INDEX "mailbox_thread_orgId_mailboxConnectionId_lastMessageAt_idx" ON "mailbox_thread"("orgId", "mailboxConnectionId", "lastMessageAt");

-- CreateIndex
CREATE INDEX "mailbox_thread_orgId_status_idx" ON "mailbox_thread"("orgId", "status");

-- CreateIndex
CREATE UNIQUE INDEX "mailbox_thread_orgId_mailboxConnectionId_providerThreadId_key" ON "mailbox_thread"("orgId", "mailboxConnectionId", "providerThreadId");

-- CreateIndex
CREATE INDEX "mailbox_message_orgId_threadId_sentAt_idx" ON "mailbox_message"("orgId", "threadId", "sentAt");

-- CreateIndex
CREATE UNIQUE INDEX "mailbox_message_orgId_threadId_providerMessageId_key" ON "mailbox_message"("orgId", "threadId", "providerMessageId");

-- CreateIndex
CREATE INDEX "mailbox_attachment_messageId_idx" ON "mailbox_attachment"("messageId");

-- CreateIndex
CREATE UNIQUE INDEX "mailbox_attachment_messageId_providerAttachmentId_key" ON "mailbox_attachment"("messageId", "providerAttachmentId");

-- CreateIndex
CREATE INDEX "mailbox_sync_run_orgId_mailboxConnectionId_startedAt_idx" ON "mailbox_sync_run"("orgId", "mailboxConnectionId", "startedAt");

-- CreateIndex
CREATE INDEX "mailbox_sync_run_orgId_status_idx" ON "mailbox_sync_run"("orgId", "status");

-- CreateIndex
CREATE INDEX "mailbox_credential_orgId_idx" ON "mailbox_credential"("orgId");

-- CreateIndex
CREATE INDEX "mailbox_credential_connectionId_idx" ON "mailbox_credential"("connectionId");
...
-- AddForeignKey
ALTER TABLE "mailbox_audit_event" ADD CONSTRAINT "mailbox_audit_event_mailboxThreadId_fkey" FOREIGN KEY ("mailboxThreadId") REFERENCES "mailbox_thread"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "mailbox_audit_event" ADD CONSTRAINT "mailbox_audit_event_mailboxMessageId_fkey" FOREIGN KEY ("mailboxMessageId") REFERENCES "mailbox_message"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "mailbox_thread" ADD CONSTRAINT "mailbox_thread_orgId_fkey" FOREIGN KEY ("orgId") REFERENCES "organization"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "mailbox_thread" ADD CONSTRAINT "mailbox_thread_mailboxConnectionId_orgId_fkey" FOREIGN KEY ("mailboxConnectionId", "orgId") REFERENCES "mailbox_connection"("id", "orgId") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "mailbox_message" ADD CONSTRAINT "mailbox_message_orgId_fkey" FOREIGN KEY ("orgId") REFERENCES "organization"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "mailbox_message" ADD CONSTRAINT "mailbox_message_threadId_fkey" FOREIGN KEY ("threadId") REFERENCES "mailbox_thread"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "mailbox_attachment" ADD CONSTRAINT "mailbox_attachment_messageId_fkey" FOREIGN KEY ("messageId") REFERENCES "mailbox_message"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "mailbox_sync_run" ADD CONSTRAINT "mailbox_sync_run_orgId_fkey" FOREIGN KEY ("orgId") REFERENCES "organization"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "mailbox_sync_run" ADD CONSTRAINT "mailbox_sync_run_mailboxConnectionId_fkey" FOREIGN KEY ("mailboxConnectionId") REFERENCES "mailbox_connection"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "mailbox_credential" ADD CONSTRAINT "mailbox_credential_orgId_fkey" FOREIGN KEY ("orgId") REFERENCES "organization"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "mailbox_credential" ADD CONSTRAINT "mailbox_credential_connectionId_fkey" FOREIGN KEY ("connectionId") REFERENCES "mailbox_connection"("id") ON DELETE SET NULL ON UPDATE CASCADE;
